...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (!content) {
    showGate('Page layout error: .workspace-content not found in HTML.', true);
    return;
  }
  ...
  content.innerHTML = `
    ...
    <section style="display:flex; gap:16px; margin-bottom:24px; flex-wrap:wrap;">
      <div style="${metricBoxStyle('#c0392b')}"><div id="cnt-incoming" style="font-size:32px; font-weight:800;">0</div><div style="font-size:11px; opacity:.8; margin-top:4px;">Incoming Pieces</div></div>
      <div style="${metricBoxStyle('#2d6a4f')}"><div id="cnt-ready" style="font-size:32px; font-weight:800;">0</div><div style="font-size:11px; opacity:.8; margin-top:4px;">Ready to Ship</div></div>
      <div style="${metricBoxStyle('#1a4a7a')}"><div id="cnt-transit" style="font-size:32px; font-weight:800;">0</div><div style="font-size:11px; opacity:.8; margin-top:4px;">In Transit → AU</div></div>
    </section>
